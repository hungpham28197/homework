...
require (
	...
	github.com/TechMaster/core v0.1.3-0.20210825050435-92abb9d0d4a8 // indirect
	github.com/TechMaster/eris v0.1.10 // indirect
	github.com/TechMaster/logger v0.1.13 // indirect
